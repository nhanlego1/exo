...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'dp_exo_site',
//        'database' => 'drupal_omnia',
      'username' => 'root',
      'password' => '',
      'host' => 'localhost',
      'port' => '',
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_exo_site_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_exo_site_dd.inc';
}
// </DDSETTINGS>
//ini_set('mbstring.http_input','pass');
//ini_set('mbstring.http_output','pass');
